<template>
  <view class="hm-tabs" v-if="ddHack" @touchmove.prevent>
    <scroll-view
      scroll-x="true"
      ...
      @touchmove.prevent
    >
      <view class="hm-tab" :id="tabId + 'tab_list'" @touchmove.prevent>
        <view
          v-for="(item, index) in tabList"
          :key="index"
          :class="[
            'hm-tab-item',
            { 'hm-tab-item--active': currentIndex === index }
          ]"
