<template>
  <view
    ...
    class="hm-popup-wrapper"
    :class="popupClass"
    :style="[popupStyles]"
  >
    <view
      class="hm-popup-content"
  ...
  computed: {
    ...
    popupContentClass: function () {
      ...
      if (
        ...
        _class += 'hm-popup-transition-' + this.transition
      }
      return _class
    },
