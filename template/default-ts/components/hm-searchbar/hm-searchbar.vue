<template>
  <view class="searchBar">
    <view class="searchBar-content" v-if="disable === false" :style="inputStyle">
      <text class="hmIcon-search" style="margin-left: 8px; color: #ccc"></text>
      <input
        ref="input"
        v-model="query"
        type="text"
      ...
      <view class="close-wrapper" @click.stop="clear">
        <text class="hmIcon-close-circle" style="color: #ddd" v-show="query"></text>
      </view>
    </view>
    <view class="searchBar-content" v-else @click.stop="clickSearch">
      <text class="hmIcon-search" style="margin-left: 8px; color: #c8c7cc"></text>
