...
MeScroll.prototype.extendDownScroll = function(optDown) {
    ...
    MeScroll.extend(optDown, {
        ...
        textOutOffset: '释放加载 ...', // 下拉的距离大于offset范围的提示文本
...
MeScroll.prototype.endDownScroll = function() {
    ...
    let endScroll = function() {
            ...
            me.optDown.endDownScroll && me.optDown.endDownScroll(me) && !me.isScrollBody && me.setScrollHeight(0) // scroll-view重置滚动区域,使数据不满屏时仍可检查触发翻页
        }
        // 结束下拉刷新时的回调
    let delay = 0
